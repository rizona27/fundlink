...
class FundHolding {
  ...
  int get holdingDays => DateTime.now().difference(navDate).inDays;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'nav_return_1m': navReturn1m,
      'nav_return_3m': navReturn3m,
      'nav_return_6m': navReturn6m,
      'nav_return_1y': navReturn1y,
      'remarks': remarks,
      'is_pinned': isPinned ? 1 : 0,
      'is_valid': isValid ? 1 : 0,
      'pinned_timestamp': pinnedTimestamp?.toIso8601String(),
  ...
  factory FundHolding.fromMap(Map<String, dynamic> map) {
    return FundHolding(
      ...
      navDate: map['nav_date'] != null ? DateTime.parse(map['nav_date'] as String) : DateTime.now(),
      currentNav: (map['current_nav'] as num?)?.toDouble() ?? 0.0,
      isValid: (map['is_valid'] as int?) == 1,
      remarks: (map['remarks'] as String?) ?? '',
      isPinned: (map['is_pinned'] as int?) == 1,
      pinnedTimestamp: map['pinned_timestamp'] != null ? DateTime.parse(map['pinned_timestamp'] as String) : null,
      navReturn1m: (map['nav_return_1m'] as num?)?.toDouble(),
